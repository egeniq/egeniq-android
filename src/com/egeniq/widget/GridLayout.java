...
public class GridLayout extends ViewGroup {
    ...
    /**
     * Returns the extra row count (the number of rows in the row count that are extra).
     * 
     * @return extra row count
     */
    public int getExtraRowCount() {
        return _extraRowCount;
    }
     ...
     * @param extraRowCount
     */
    public void setExtraRowCount(int extraRowCount) {
        _extraRowCount = extraRowCount;
        requestLayout();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        double widthFactor = (double)getColumnCount() / ((double)getColumnCount() - (double)getExtraColumnCount());
        width = (int)Math.floor(width * widthFactor);

        // make the grid taller than its parent so the extra rows are initially off screen
        double heightFactor = (double)getRowCount() / ((double)getRowCount() - (double)getExtraRowCount());
